  ...
  return (
    <footer className="bg-black text-gray-300 py-12 px-6 md:px-12 lg:px-20">
        ...
        <div>
          ...
          <ul className="space-y-3 text-sm">
            <li className="flex items-center space-x-2">
              ...
              <span>+44 7368 238938</span>
            </li>
            <li className="flex items-start space-x-2">
              <FiMapPin className="text-primary  mt-1" />
              <span>
                Unit 9, Derwent Industrial Estate,
                <br />
                 Hawkins Ln, Burton-on-Trent DE14 1QA, United Kingdom
              </span>
            </li>
          </ul>
        </div>
      ...
      <div className="mt-10 border-t border-gray-700 pt-6 text-center text-sm text-gray-400">
        ...
        <span className="text-primary ">Primal Instinct</span> | Powered by{" "}
